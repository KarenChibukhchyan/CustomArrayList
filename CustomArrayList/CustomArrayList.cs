...
namespace CustomArrayList
{
    public class CustomArrayList : IEnumerable<object>
    {
        ...
        static readonly object[] _emptyArray = new object[0];
        private int _size;
        ...
        {
            return new CustomListEnumerator(_items, _size);
        }
        ...
        public void CopyTo(object[] targetArray, int insertionIndex)
        {
        ...
        public void CopyTo(int insertionIndex, object[] targetArray, int rangeStartIndex, int rangeEndIndex)
        {
        ...
        public void InsertRange(int insertionIndex, int[] arrayToInsert)
        {
